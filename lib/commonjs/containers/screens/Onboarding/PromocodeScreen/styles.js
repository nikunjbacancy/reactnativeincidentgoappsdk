...
exports.ValidationText = exports.ValidationRow = exports.TitleText = exports.TitleRow = exports.SubmitButtonRow = exports.ResendText = exports.LogoRow = exports.InputRow = exports.CodeTextField = exports.CodeError = exports.Background = exports.BackButtonCol = void 0;
...
`;
const ValidationRow = exports.ValidationRow = _styled.default.View`
  margin: 5px 35px 15px;
`;
const ValidationText = exports.ValidationText = _styled.default.Text`
  font-size: 12px;
  color: ${({
  theme
}) => theme.colors.dark};
