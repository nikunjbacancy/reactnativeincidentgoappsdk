...
exports.TitleText = exports.TitleRow = exports.SettingButton = exports.LogoRow = exports.ItemText = exports.ItemRow = exports.ItemIcon = exports.ButtonRow = exports.Background = exports.AlreadyAllowed = exports.AllowButton = void 0;
...
`;
const SettingButton = exports.SettingButton = (0, _styled.default)(_components.GradientButton)`
background-color: ${({
  theme
}) => theme.colors.highlight2};
margin-bottom: 10px;
`;
const AlreadyAllowed = exports.AlreadyAllowed = (0, _styled.default)(_components.GradientButton)`
background-color: ${({
  theme
}) => theme.colors.highlight};
margin-bottom: 10px;
`;
const AllowButton = exports.AllowButton = (0, _styled.default)(_components.GradientButton)`
background-color: ${({
  theme
}) => theme.colors.highlight};
margin-bottom: 10px;
