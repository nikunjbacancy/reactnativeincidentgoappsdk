...
const ExitPanicModal = ({
  ...
  const handleContinue = (0, _react.useCallback)(() => {
    if ((0, _toLower.default)(comment) === 'exit') {
      onConfirm(comment);
      setComment('');
      setError(false);
      hideModal();
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNativeModal.default, {
    ...
    avoidKeyboard: true
  }, /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(Title, null, formatMessage(_messages.default.exitPanicModalTitle)), /*#__PURE__*/_react.default.createElement(MessageRow, null, /*#__PURE__*/_react.default.createElement(Message, null, formatMessage(_messages.default.exitPanicModalInfo))), /*#__PURE__*/_react.default.createElement(InputRow, null, /*#__PURE__*/_react.default.createElement(InputText, {
    value: comment,
    onChangeText: setComment,
    placeholder: formatMessage(_messages.default.exitPanicModalPlaceholder)
  })), error && /*#__PURE__*/_react.default.createElement(ErrorText, null, formatMessage(_messages.default.exitPanicModalInputValidation)), /*#__PURE__*/_react.default.createElement(ButtonContainer, null, /*#__PURE__*/_react.default.createElement(CancelButton, {
    onPress: hideModal,
    text: formatMessage(_messages.default.exitPanicModalCancel)
  }), /*#__PURE__*/_react.default.createElement(ConfirmButton, {
    onPress: handleContinue,
    text: formatMessage(_messages.default.exitPanicModalConfirm)
  }))));
};
...
`;
const ConfirmButton = (0, _styled.default)(_components.GradientButton).attrs(({
  theme
}) => ({
  textStyle: {
...
`;
const ErrorText = _styled.default.Text`
...
`;
var _default = exports.default = /*#__PURE__*/(0, _react.memo)(ExitPanicModal);
