...
const SafeModal = ({
  ...
  }), /*#__PURE__*/_react.default.createElement(Title, null, title), /*#__PURE__*/_react.default.createElement(MessageRow, null, /*#__PURE__*/_react.default.createElement(Message, null, info)), /*#__PURE__*/_react.default.createElement(InputRow, null, /*#__PURE__*/_react.default.createElement(InputText, {
    value: input,
  ...
  })), alert ? /*#__PURE__*/_react.default.createElement(MessageRow, null, /*#__PURE__*/_react.default.createElement(AlertMessage, null, alert)) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null), /*#__PURE__*/_react.default.createElement(ButtonContainer, null, /*#__PURE__*/_react.default.createElement(CancelButton, {
    onPress: hideModal,
    text: cancel
...
const Message = _styled.default.Text`
  ...
  text-align: center;
`;
const AlertMessage = _styled.default.Text`
  font-family: ${({
  theme
}) => theme.fonts.defaultFamily};
  font-size: 16px;
