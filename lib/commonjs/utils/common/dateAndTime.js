...
exports.formatUTCtoLocalDate = formatUTCtoLocalDate;
exports.getTimeAgo = exports.getLocalTime = void 0;
...
function formatUTCtoLocalDate(utcDateString) {
  ...
  const formattedDate = (0, _dateFns.format)(date, 'MMM dd, hh:mm a');
  const now = new Date();
