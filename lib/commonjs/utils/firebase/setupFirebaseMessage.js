...
var _constants2 = require("../../containers/screens/Home/Escort/RecordScreen/constants");
...
const sendLocalMessage = async message => {
  ...
  if (((_message$data = message.data) === null || _message$data === void 0 ? void 0 : _message$data.type) === _incidentCodeCore.IncidentType.Normal && ((_message$data2 = message.data) === null || _message$data2 === void 0 ? void 0 : _message$data2.event) === 'resolved') {
    var _message$data3;
    _api.event.emit(_api.AppEvent.OnIncidentUpdated, (_message$data3 = message.data) === null || _message$data3 === void 0 ? void 0 : _message$data3.tipId);
    return;
  }
  // //("step -- 2")
  if ((((_message$data4 = message.data) === null || _message$data4 === void 0 ? void 0 : _message$data4.type) === _incidentCodeCore.IncidentType.Escort || ((_message$data5 = message.data) === null || _message$data5 === void 0 ? void 0 : _message$data5.type) === _incidentCodeCore.IncidentType.PassiveEscort) && ((_message$data6 = message.data) === null || _message$data6 === void 0 ? void 0 : _message$data6.event) === 'resolved') {
    var _message$data7;
    _api.event.emit(_api.AppEvent.OnEscortClosed, (_message$data7 = message.data) === null || _message$data7 === void 0 ? void 0 : _message$data7.tipId);
    return;
  }
  // //("step -- 3")
  // if (
  ...
  if (((_message$data8 = message.data) === null || _message$data8 === void 0 ? void 0 : _message$data8.type) === 'group' && ((_message$data9 = message.data) === null || _message$data9 === void 0 ? void 0 : _message$data9.event) === 'groupChanged' || ((_message$data10 = message.data) === null || _message$data10 === void 0 ? void 0 : _message$data10.event) === 'groupUpdated') {
    _api.event.emit(_api.AppEvent.OnOrganizationGroupUpdated, "OnOrganizationGroupUpdated");
    return;
  }
  if (((_message$data11 = message.data) === null || _message$data11 === void 0 ? void 0 : _message$data11.type) === 'Location' && ((_message$data12 = message.data) === null || _message$data12 === void 0 ? void 0 : _message$data12.event) === 'LocationQuestion') {
    ...
    (0, _device.sendLocalNotification)({
  ...
  if (((_message$data19 = message.data) === null || _message$data19 === void 0 ? void 0 : _message$data19.type) === 'logout_user') {
    _api.event.emit(_api.AppEvent.OnLogout, message.notification);
    return;
  }
  ...
  if ((_message$data25 = message.data) !== null && _message$data25 !== void 0 && _message$data25.incidentId) {
    await (0, _notification.addBadge)(message.data.incidentId);
  }
  const escortState = await _asyncStorage.default.getItem(_constants2.ESCORT_STATE_KEY);
...
const setupFirebaseMessage = () => {
  ...
  (0, _messaging.default)().onMessage(message => {
    var _message$data52, _message$data53;
    console.log("onMessage=====>", JSON.stringify(message));
    if (_device.isIos == false) {
      sendLocalMessage(message);
    } else {
      ...
      if (((_message$data26 = message.data) === null || _message$data26 === void 0 ? void 0 : _message$data26.type) === _incidentCodeCore.IncidentType.Normal && ((_message$data27 = message.data) === null || _message$data27 === void 0 ? void 0 : _message$data27.event) === 'resolved') {
        var _message$data28, _message$data29;
        let options = {
          title: _messages.default.myTips,
          message: _messages.default.tipDescription,
          // Reference message ID from translation file
          userInfo: message
        };
        _reactNativePushNotification.default.localNotification(options);
        _api.event.emit(_api.AppEvent.OnIncidentUpdated, (_message$data28 = message.data) === null || _message$data28 === void 0 ? void 0 : _message$data28.tipId);
        _api.event.emit(_api.AppEvent.OnRefreshNotificationList, (_message$data29 = message.data) === null || _message$data29 === void 0 ? void 0 : _message$data29.tipId);
        return;
      }
      if ((((_message$data30 = message.data) === null || _message$data30 === void 0 ? void 0 : _message$data30.type) === _incidentCodeCore.IncidentType.Escort || ((_message$data31 = message.data) === null || _message$data31 === void 0 ? void 0 : _message$data31.type) === _incidentCodeCore.IncidentType.PassiveEscort) && ((_message$data32 = message.data) === null || _message$data32 === void 0 ? void 0 : _message$data32.event) === 'resolved') {
        var _message$data33, _message$data34;
        _api.event.emit(_api.AppEvent.OnRefreshNotificationList, (_message$data33 = message.data) === null || _message$data33 === void 0 ? void 0 : _message$data33.tipId);
        _api.event.emit(_api.AppEvent.OnEscortClosed, (_message$data34 = message.data) === null || _message$data34 === void 0 ? void 0 : _message$data34.tipId);
        return;
      }
      if (((_message$data35 = message.data) === null || _message$data35 === void 0 ? void 0 : _message$data35.type) === 'Escort' && (((_message$data36 = message.data) === null || _message$data36 === void 0 ? void 0 : _message$data36.event) === 'PanicAccepted' || ((_message$data37 = message.data) === null || _message$data37 === void 0 ? void 0 : _message$data37.event) === 'PanicCreated')) {
        ...
        _reactNativePushNotification.default.localNotification(options);
        _api.event.emit(_api.AppEvent.OnRefreshNotificationList, message);
        return;
      }
      ...
      if ((message === null || message === void 0 || (_message$data43 = message.data) === null || _message$data43 === void 0 ? void 0 : _message$data43.link) != undefined) {
        ...
        _reactNativePushNotification.default.localNotification(options);
        _api.event.emit(_api.AppEvent.OnRefreshNotificationList, "NotifyUser");
      }
      if (((_message$data44 = message.data) === null || _message$data44 === void 0 ? void 0 : _message$data44.type) === 'group' && ((_message$data45 = message.data) === null || _message$data45 === void 0 ? void 0 : _message$data45.event) === 'groupChanged' || ((_message$data46 = message.data) === null || _message$data46 === void 0 ? void 0 : _message$data46.event) === 'groupUpdated') {
        _api.event.emit(_api.AppEvent.OnRefreshNotificationList, "OnOrganizationGroupUpdated");
        _api.event.emit(_api.AppEvent.OnOrganizationGroupUpdated, "OnOrganizationGroupUpdated");
        return;
      }
      if (((_message$data47 = message.data) === null || _message$data47 === void 0 ? void 0 : _message$data47.type) === 'logout_user') {
        _api.event.emit(_api.AppEvent.OnLogout, message === null || message === void 0 ? void 0 : message.notification);
        return;
      }
  ...
  (0, _messaging.default)().onNotificationOpenedApp(async remoteMessage => {
    ...
    if (((_remoteMessage$data = remoteMessage.data) === null || _remoteMessage$data === void 0 ? void 0 : _remoteMessage$data.type) === 'logout_user') {
      _api.event.emit(_api.AppEvent.OnLogout, remoteMessage === null || remoteMessage === void 0 ? void 0 : remoteMessage.notification);
    }
  });
  (0, _messaging.default)().getInitialNotification().then(async remoteMessage => {
  ...
  (0, _messaging.default)().setBackgroundMessageHandler(async message => {
    ...
    if ((_message$data54 = message.data) !== null && _message$data54 !== void 0 && _message$data54.incidentId) {
      await _asyncStorage.default.setItem(_constants.ANDROID_HEADLESS_NOTIFICATION_KEY, message.data.incidentId);
    }
    // sendLocalMessage(message);
    ...
    if (((_message$data57 = message.data) === null || _message$data57 === void 0 ? void 0 : _message$data57.type) === 'geofence' && ((_message$data58 = message.data) === null || _message$data58 === void 0 ? void 0 : _message$data58.event) === 'polygon') {
      ...
      (0, _backgroundGeolocation.crudGeofenceOperation)(payloaData.data, (_message$data61 = message.data) === null || _message$data61 === void 0 ? void 0 : _message$data61.isCron);
    }
...
var _default = exports.default = setupFirebaseMessage;
