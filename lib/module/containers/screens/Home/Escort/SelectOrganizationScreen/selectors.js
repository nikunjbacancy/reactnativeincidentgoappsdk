...
const selectOrganizationScreenStateDomain = state => state.escortSelectOrganizationScreen || initialState;
...
const makeSelectOrgGroups = () => createSelector(selectOrganizationScreenStateDomain, state => {
