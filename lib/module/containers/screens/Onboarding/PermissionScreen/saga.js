...
import { checkBlockedPermission, requestAllPermissions, showOpenConfigMessage } from '../../../../utils/permission';
...
function* goToNextScreen() {
  if (isAndroid) {
    ...
    const nextScreen = isActive ? Screens.Onboarding.PermissionLocation : Screens.Onboarding.ActivateGPS;
