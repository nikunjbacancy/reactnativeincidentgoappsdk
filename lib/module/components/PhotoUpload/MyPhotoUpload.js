...
import { View, Image, StyleSheet, TouchableOpacity, Platform, Alert } from 'react-native';
    ...
    _defineProperty(this, "openImagePicker", async () => {
      ...
      if (permission === "granted") {
        ...
        launchImageLibrary(this.options, async response => {
          ...
          // resize image
          const resizedImageUri = await ImageResizer.createResizedImage(imageURI, maxHeight, maxWidth, format, quality, rotation);
        ...
        Alert.alert(this.props.alertTitle, this.props.alertMessage, [{
          text: "Cancel",
...
_defineProperty(MyPhotoUpload, "propTypes", {
  ...
  onTapCustomButton: PropTypes.func,
  ...
  // after render
  onResizedImageUri: PropTypes.func,
  // when image resized is ready
  imagePickerProps: PropTypes.object,
