  ...
  PNotification.configure({
    ...
    onNotification: async notification => {
      ...
      if (isIos) {
        ...
        if (((_notification$data3 = notification.data) === null || _notification$data3 === void 0 ? void 0 : _notification$data3.type) === IncidentType.Normal && ((_notification$data4 = notification.data) === null || _notification$data4 === void 0 ? void 0 : _notification$data4.event) === 'resolved') {
        ...
        if (((_notification$data6 = notification.data) === null || _notification$data6 === void 0 || (_notification$data6 = _notification$data6.data) === null || _notification$data6 === void 0 ? void 0 : _notification$data6.type) === IncidentType.Normal && ((_notification$data7 = notification.data) === null || _notification$data7 === void 0 || (_notification$data7 = _notification$data7.data) === null || _notification$data7 === void 0 ? void 0 : _notification$data7.event) === 'resolved') {
        ...
        if (((_notification$data9 = notification.data) === null || _notification$data9 === void 0 || (_notification$data9 = _notification$data9.data) === null || _notification$data9 === void 0 ? void 0 : _notification$data9.type) === IncidentType.Normal && ((_notification$data10 = notification.data) === null || _notification$data10 === void 0 || (_notification$data10 = _notification$data10.data) === null || _notification$data10 === void 0 ? void 0 : _notification$data10.event) === 'resolved') {
      ...
      if (
      // @ts-ignore
      ((_notification$data12 = notification.data) === null || _notification$data12 === void 0 ? void 0 : _notification$data12.type) === IncidentType.Escort &&
      // @ts-ignore
      ((_notification$data13 = notification.data) === null || _notification$data13 === void 0 ? void 0 : _notification$data13.event) === 'resolved') {
        ...
        // console.log("Incident Escort --------- ");
        // @ts-ignore
        event.emit(AppEvent.OnEscortClosed, (_notification$data14 = notification.data) === null || _notification$data14 === void 0 ? void 0 : _notification$data14.tipId);
        return;
      }
      if (
      // @ts-ignore
      ...
      if (
      // @ts-ignore
      ((_notification$data25 = notification.data) === null || _notification$data25 === void 0 ? void 0 : _notification$data25.type) === IncidentType.PassiveEscort &&
      // @ts-ignore
      ((_notification$data26 = notification.data) === null || _notification$data26 === void 0 ? void 0 : _notification$data26.event) === 'resolved') {
        ...
        // @ts-ignore
        event.emit(AppEvent.OnEscortClosed, (_notification$data27 = notification.data) === null || _notification$data27 === void 0 ? void 0 : _notification$data27.tipId);
        return;
      }
      if (
      // @ts-ignore
      ...
      if (isIos) {
        if (notification.foreground == false) {
          ...
          if (((_notification$data30 = notification.data) === null || _notification$data30 === void 0 ? void 0 : _notification$data30.data.type) === 'chat' && ((_notification$data31 = notification.data) === null || _notification$data31 === void 0 ? void 0 : _notification$data31.data.event) === 'Message') {
            ...
            event.emit(AppEvent.OnChatMessageTap, (_notification$data32 = notification.data) === null || _notification$data32 === void 0 ? void 0 : _notification$data32.data);
            return;
          }
        }
      } else {
        ...
        if (((_notification$data33 = notification.data) === null || _notification$data33 === void 0 ? void 0 : _notification$data33.data.type) === 'chat' && ((_notification$data34 = notification.data) === null || _notification$data34 === void 0 ? void 0 : _notification$data34.data.event) === 'Message') {
          ...
          event.emit(AppEvent.OnChatMessageTap, (_notification$data35 = notification.data) === null || _notification$data35 === void 0 ? void 0 : _notification$data35.data);
          return;
        }
      }
      if (
      // @ts-ignore
      ((_notification$data36 = notification.data) === null || _notification$data36 === void 0 ? void 0 : _notification$data36.incidentType) === IncidentType.Escort || // @ts-ignore
