export default {
  ...
  containers: {
    ...
    welcomeScreen: {
      emergency: {
        title: 'Incident Go is an On-Demand safety service that was created to bring peace of mind.',
        text: 'Security Agents are available 24/7 to help with any security-based need.'
      },
      live: {
        title: 'Live Security Escort',
        text: 'Never walk alone. Turn your phone’s camera and audio into a live streaming device connected to a Security Agent, who will assist you safely to your destination.'
      },
      safety: {
        title: 'Safety Timer',
        text: 'The Safety Timer enables you to set a timer that sends an alert to your Security Agent upon its expiration. The Security Agent then contacts you to ensure your safety.'
      },
      panic: {
        title: 'Panic Button',
        text: 'Panic buttons are available throughout the app. A simple 2-second press of the panic button alerts your Security Agent that immediate assistance is required, while sending video, audio, and GPS.'
      },
      tip: {
        title: 'Security Tip',
        text: 'Take a video or discretely chat with a live Security Agent for an immediate response.'
      },
      skip: 'Skip'
    },
    signInScreen: {
    ...
    signInCodeScreen: {
      title: 'Please enter the 4-digit code from the text message you received, or select {resendCode}',
    ...
    updateNameScreen: {
      ...
      privacy: 'Your name is private and will only be released when you decide to share a tip with your organization or contacts.',
    ...
    permissionScreen: {
      location: 'IncidentGO will share your location in the background for sitekey, panic button, safety timer, timed checklist, and virtual escort with security personnel when requesting assistance.',
      camera: 'This app uses video to let you record, in order to maximize the sharing of actionable information.',
      microphone: 'This app uses your mic to allow video’s to have audio, giving pertinent information.',
      title: 'In order to use the Incident GO app, please allow the app to use location, mic and camera services.',
      allow: 'Allow',
      notYet: 'Not yet',
      openPermissionsConfig: 'All Incident GO permissions must be accepted to proceed'
    },
    permissionLocationScreen: {
      location: 'To allow the application to track your location and determine which incidents occur around your area and collect location data for sitekey, set the Location Access to ALWAYS.',
      // location:
      ...
      title: 'In order to use the Incident GO app, please allow the app to use location services.',
      settings: 'Settings',
    ...
    activateGPSScreen: {
      title: 'In order for the app to help you we will need you to authorize and active your GPS. Thanks',
    ...
    videoRecordScreen: {
      ...
      cancelIncidentMessage: 'This action will delete videos you have recorded for this incident.',
      no: 'No',
      yes: 'Yes',
      tipCreatedTitle: 'Tip for {organizationName} was successfully created!',
      tipCreatedMessage: 'You can now add more videos and chat with the organization on the tip page.',
      acknowledgment: 'Thank you!',
      seeMyTip: 'Open this tip',
      checkingPermissions: 'Checking permissions',
      permissionsBlockedMessage: 'This app needs camera and microphone permission to work',
      tryAgain: 'Try again',
    ...
    organizationNotifyScreen: {
      title: 'New tip',
      info: 'Select the organization to notify.\nSelecting an organization will create a new tip.',
      call911Title: 'There are no available organizations to report at this location. Your tip will be sent to your contact list.',
    ...
    incidentCategoryScreen: {
      title: 'New tip',
      info: 'Select a type of incident for the tip you are reporting to {organizationName}',
      continue: 'Continue'
    },
    addCommentScreen: {
      title: 'New tip',
      info: 'To add more information for {organizationName} about this tip, you can enter a comment bellow:',
      inputPlaceholder: 'Commentary (optional)',
      createTip: 'Create tip',
      acknowledgment: 'Thank you for sharing this information. This tip will be reported to {organizationName}.'
    },
    myTipsScreen: {
      title: 'My tips',
      address: 'Address:',
      ...
      violationInfo: "This video has been flagged as '${type}' and will be hidden until reviewed by an admin.",
      escort: 'Escort',
    ...
    feedbackScreen: {
      ...
      guideDescription: 'You can also view the {guideText}, {faq}, {privacy} and {tos}',
      ...
      ok: 'Ok',
      locationLogDesc: 'Click below to email the device location log to developers',
    ...
    contactScreen: {
      ...
      info: 'Add contacts that will receive a text message when you create a tip.',
      footerMax: 'You are at your maximum allowable contacts. Please remove a contact to add more.',
      noContacts: 'No contacts added',
      noMatches: 'No matches found',
      searchPlaceholder: 'Search contacts',
      title: 'Contacts',
      contactPermissionError: 'You must change your phone system settings to allow this app to access your contacts.',
      warning: 'Listed contacts will automatically receive a text message with the link to your tip.'
    },
    settingScreen: {
    ...
    escort: {
      ...
      requestScreen: {
        requestEscort: 'Request escort',
        timedTitle: 'Countdown expired requesting Live Security Escort, please wait...',
        timedMessage: 'When the Live Security Escort starts, a member of security personnel will escort you by following your position.\n\nYou will also be required to share either your phone’s audio or video with them.\n\nA panic button will be available if you need immediate assistance.',
        panicTitle: 'Panic initated requesting Live Security Escort, please wait...',
        panicMessage: 'When the Live Security Escort starts, a member of security personnel will escort you by following your position.\n\nYou will also be required to share either your phone’s audio or video with them.',
        liveTitle: 'Your Live Security Escort request is pending, please wait...',
        liveMessage: 'When the Live Security Escort starts, a member of security personnel will escorting you by following your position.\n\nYou will also be required to share either your phone’s audio or video with him/her.\n\nA panic button will be available if you need immediate assistance.',
        cancelRequest: 'Cancel request',
        cancelEscortModalTitle: 'This action\nwill cancel this escort request, but you will be able to restart it again afterwards.',
        cancelEscortModalInfo: 'A panic button will be available if you need immediate assistance.',
      ...
      recordScreen: {
        ...
        exitPanicModalInfo: "To exit, please type EXIT below and click 'Confirm'",
      ...
      escortTypeScreen: {
        title: 'Select Escort',
        incidentCo: 'INCIDENT GO',
        safetyEscortLabel: 'Set the timer and if it expires before you cancel, a panic alert will be sent.',
        safetyEscortButton: 'Safety Timer',
        timedEscortLabel: 'Complete a pre-defined checklist in a given time, or a panic alert will be sent.',
      ...
      countdownScreen: {
        ...
        safetyPreCountdown: 'When the timer expires, an alert will be sent to your Security Agent.',
        ...
        exitPanicModalConfirm: 'CONFIRM',
        exitPanicModalInputValidation: 'Please try again',
        requestEscortTitle: 'Countdown expired requesting Live Security Escort, please wait...',
        panicRequestEscortTitle: 'Panic initated requesting Live Security Escort, please wait...',
        requestEscortMessage: 'When the Live Security Escort starts, a member of security personnel will escort you by following your position.\n\nYou will also be required to share either your phone’s audio or video with them.\n\nA panic button will be available if you need immediate assistance.',
        panicRequestEscortMessage: 'When the Live Security Escort starts, a member of security personnel will escort you by following your position.\n\nYou will also be required to share either your phone’s audio or video with them.',
        openPermissionsConfig: 'All Incident GO permissions must be accepted to proceed',
        safeModalTitle: 'Are you safe?',
        safeModalInfo: 'Type your initials in the box below and press <<Continue>> to finish the Escort.',
