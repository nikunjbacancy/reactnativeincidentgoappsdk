...
export type MyAccountActionTypes = UpdateMyAccountNameRequestAction | UpdateMyAccountNameSuccessAction | UpdateMyAccountNameFailureAction | UpdatePortraitRequestAction | UpdatePortraitSuccessAction | UpdatePortraitFailureAction | DeletePortraitAction | DeletePortraitSuccessAction | DeletePortraitFailureAction | ClearMessageTypeAction;
