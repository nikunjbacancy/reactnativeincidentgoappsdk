...
export type TipDetailActionTypes = GetIncidentVideosRequestAction | GetIncidentVideosSuccessAction | GetIncidentVideosFailureAction | ShowCallModalAction | HideCallModalAction | ShowChatModalAction | HideChatModalAction | UploadVideoRequestAction | UploadVideoSuccessAction | UploadVideoFailureAction | AddIncidentVideoAction | GetMessagesRequestAction | GetMessagesSuccessAction | GetMessagesFailureAction | SendMessageRequestAction | SendMessageSuccessAction | SendMessageFailureAction | GetIncidentRequestAction | GetIncidentSuccessAction | GetIncidentFailureAction | AddMessageAction;
