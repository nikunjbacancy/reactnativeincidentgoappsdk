...
export declare const initialState: TipDetailState;
declare const tipDetailScreenReducer: <Base extends {
    readonly incident?: {
        readonly id?: string | {
    ...
    readonly incidentVideos: readonly {
        readonly id?: string | {
            readonly generationTime: number;
            readonly equals: (otherID: string | import("incident-code-core").ObjectId) => boolean;
            readonly getTimestamp: () => Date;
    ...
    readonly isLoadingIncident: boolean;
...
}>(base?: Base | undefined, action: TipDetailActionTypes) => Base;
