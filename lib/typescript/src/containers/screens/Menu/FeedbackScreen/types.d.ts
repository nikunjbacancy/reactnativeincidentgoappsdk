 ...
 *
 */
import { HIDE_SUCCESS_MODAL, SEND_FEEDBACK_FAILURE, SEND_FEEDBACK_REQUEST, SEND_FEEDBACK_SUCCESS, SHOW_SUCCESS_MODAL, UPDATE_USER_EMAIL } from './constants';
...
export type FeedbackActionTypes = SendFeedbackRequestAction | SendFeedbackSuccessAction | SendFeedbackFailureAction | UpdateUserEmailAction | ShowSuccessModalAction | HideSuccessModalAction;
