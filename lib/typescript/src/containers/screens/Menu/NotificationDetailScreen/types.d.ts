...
export type NotificationActionTypes = ToggleUserNotificationRequestAction | ToggleUserNotificationSuccessAction | ToggleUserNotificationFailureAction | DeleteUserRequest | DeleteUserSuccessAction | DeleteUserFailureAction | ResetDeleteUserAction;
