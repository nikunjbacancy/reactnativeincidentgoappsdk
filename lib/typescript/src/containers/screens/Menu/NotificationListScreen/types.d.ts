...
export type NotificationListActionTypes = NotificationListRequestAction | NotificationListSuccessAction | NotificationListFailureAction | NotificationListResetAction | NotificationReadUnreadRequestAction | NotificationReadUnreadSuccessAction | NotificationReadUnreadFailureAction | ResetNotificationReadUnreadAction | NotificationUnreadCountAction | ReadAllNotificationRequestAction | ReadAllNotificationSuccessAction | ReadAllNotificationFailureAction;
