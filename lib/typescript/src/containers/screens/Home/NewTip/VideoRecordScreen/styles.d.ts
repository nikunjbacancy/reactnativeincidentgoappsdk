...
export declare const Camera: import("styled-components").StyledComponent<typeof RNCamera, {
    text: {
        color: string;
        fontSize: string;
        fontFamily: string;
...
export declare const AcknowledgmentText: any;
export declare const BlockedPermissionContainer: any;
export declare const BlockedPermissionMessage: any;
export declare const TipCameraContainer: any;
