...
import { CreateTipMode, NewTipActionTypes, NewTipState } from './types';
export declare const initialState: NewTipState;
declare const newTipReducer: <Base extends {
    readonly shouldShowCancelIncidentModal: boolean;
    readonly shouldShowCallModal: boolean;
    readonly deletingIncident: boolean;
    readonly userOrganizations: readonly {
        readonly id?: string | {
    ...
    readonly shouldShowTipCreatedModal: boolean;
    readonly tipCreatedData: {
        readonly incident: {
            readonly id?: string | {
                readonly generationTime: number;
                readonly equals: (otherID: string | import("incident-code-core").ObjectId) => boolean;
    ...
    readonly createTipMode: CreateTipMode;
    readonly creatingTipWithChat: boolean;
    readonly uploadingVideo: boolean;
    readonly shouldShowFastAccessModal: boolean;
    readonly lastTipOrganization?: {
        readonly id?: string | {
            readonly generationTime: number;
            readonly equals: (otherID: string | import("incident-code-core").ObjectId) => boolean;
            readonly getTimestamp: () => Date;
...
}>(base?: Base | undefined, action: NewTipActionTypes) => Base;
