...
export type NewTipActionTypes = UploadVideoRequestAction | UploadVideoSuccessAction | UploadVideoFailureAction | CreateIncidentRequestAction | CreateIncidentSuccessAction | CreateIncidentFailureAction | DeleteIncidentRequestAction | DeleteIncidentSuccessAction | DeleteIncidentFailureAction | AddIncidentVideoAction | ShowCancelIncidentModalAction | HideCancelIncidentModalAction | ShowCallModalAction | HideCallModalAction | GetUserOrganizationsRequestAction | GetUserOrganizationsSuccessAction | GetUserOrganizationsFailureAction | CreateTipWithChatRequestAction | CreateTipWithChatSuccessAction | CreateTipWithChatFailureAction | ShowTipCreatedModalAction | HideTipCreatedModalAction | ShowFastAccessModalAction | HideFastAccessModalAction | GetLastActiveTipOrganizationRequestAction | GetLastActiveTipOrganizationSuccessAction | GetLastActiveTipOrganizationFailureAction;
