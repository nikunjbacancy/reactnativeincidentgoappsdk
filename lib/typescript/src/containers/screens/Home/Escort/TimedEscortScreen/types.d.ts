...
import { IntersectOrganizationSelection, OrganizationSelection, ProcedureSelection } from 'types';
...
export type TimedEscortActionTypes = GetIntersectOrganizationsRequestAction | GetIntersectOrganizationsSuccessAction | GetIntersectOrganizationsFailureAction | ToggleSelectOrganizationAction | GetOrganizationProceduresRequestAction | GetOrganizationProceduresFailureAction | GetOrganizationProceduresSuccessAction | ToggleSelectProcedureAction | ClearSelectionsAction;
