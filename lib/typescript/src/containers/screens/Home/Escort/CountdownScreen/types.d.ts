...
export type CountdownClockActionTypes = GetProcedureRequestAction | GetProcedureSuccessAction | GetProcedureFailureAction | ShowSetTimerModalAction | HideSetTimerModalAction | SetTimerValueRequestAction | SetTimerValueSuccessAction | SetTimerValueFailureAction | CompleteProcedureActionAction | ShowSafeModalAction | HideSafeModalAction | ShowCallModalAction | HideCallModalAction | ShowPanicInfoAction | HidePanicInfoAction | EnterPanicModeAction | EnterPanicModeSuccessAction | ShowExitPanicModalAction | HideExitPanicModalAction | ImSafeRequestAction | ImSafeSuccessAction | ImSafeFailureAction | TriggerCountdownWarningAction | CancelCountdownWarningAction | StartPassiveEscortRequestAction | StartPassiveEscortSuccessAction | StartPassiveEscortFailureAction | StartVirtualEscortRequestAction | StartVirtualEscortSuccessAction | StartVirtualEscortFailureAction | ClearAreYouSafeAction | LogEscortActionRequestAction | LogEscortActionRequestFailure | EnterPanicModeFailureAction | ClearEscortErrorAction | ClearProcedure | SetSafetyTimerAction;
