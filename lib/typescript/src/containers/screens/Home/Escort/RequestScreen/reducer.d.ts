...
export declare const initialState: RequestEscortState;
declare const selectOrganizationScreenReducer: <Base extends {
    readonly requestingEscort: boolean;
    readonly error: boolean;
    readonly errorMessage: string;
    readonly shouldShowCancelEscortModal: boolean;
    readonly pendingEscort?: {
        readonly id?: string | {
...
}>(base?: Base | undefined, action: RequestEscortActionTypes) => Base;
