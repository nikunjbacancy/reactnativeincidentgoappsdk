...
import { AccessToken, AppUser, Config, ErrorLog, Incident, IncidentCategoryConfig, IncidentEscort, Organization, OrganizationProcedure, OrganizationWithArea, Ref } from 'incident-code-core';
...
import { AddIncidentVideoAction, CreateIncidentSuccessAction, DeleteIncidentSuccessAction } from '../screens/Home/NewTip/VideoRecordScreen/types';
...
import { DeleteContactSuccessAction, ToggleContactNotificationSuccessAction } from '../screens/Menu/ManageContacts/ContactScreen/types';
...
export type AppActionTypes = GetConfigsRequestAction | GetConfigsSuccessAction | GetConfigsFailureAction | UpdateProfileRequestAction | GetProfileRequestAction | GetProfileSuccessAction | GetProfileFailureAction | SetTipCameraModeAction | SetTipCameraVideoIndexAction | FinishWelcomeAction | LoginSuccessAction | UpdateNameSuccessAction | UpdateOrganizationsSuccessAction | AllPermissionsSuccessAction | CreateIncidentSuccessAction | AddIncidentVideoAction | DeleteIncidentSuccessAction | AddSelectedOrganizationSuccessAction | SelectCategoryAction | AddIncidentCommentAction | UpdateMyAccountNameSuccessAction | UpdateUserEmailAction | DeleteUserOrganizationSuccessAction | DeleteContactSuccessAction | AddContactSuccessAction | ToggleUserNotificationSuccessAction | ToggleContactNotificationSuccessAction | GetTwilioAccessTokenRequestAction | GetTwilioAccessTokenSuccessAction | GetTwilioAccessTokenFailureAction | SelectedSiteKeyLocation | SetIncidentEscortDataAction | ClearIncidentEscortDataAction | SetPassiveEscortDataAction | ClearPassiveEscortDataAction | UpdateUserPortraitAction | UpdateLocationAction | ClearLocationAction | LogErrorAction;
