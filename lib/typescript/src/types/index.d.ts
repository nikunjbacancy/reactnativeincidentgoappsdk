import { Incident, IncidentVideo, LatLng, Organization, OrganizationProcedure, OrganizationWithArea, ProcedureAction } from 'incident-code-core';
...
export interface FormatMessage {
    (descriptor: MessageDescriptor, values?: Record<string, PrimitiveType>): string;
    (descriptor: MessageDescriptor, values?: Record<string, PrimitiveType | ReactElement | FormatXMLElementFn>): string | ReactNodeArray;
}
