...
export type ResolveGeoPosition = (
  value?: GeoPosition | PromiseLike<GeoPosition> | undefined,
) => void;

export type RejectGeoError = (reason?: GeoError) => void;

import {
  LOCATION_TRACKING_FAILURE,
...
export type LocationTrackListActionTypes =
  | LocationTrackRequestAction
  | LocationTrackSuccessAction
  | LocationTrackFailureAction
  | GeoStatusRequestAction
  | GeoStatusSuccessAction
  | GeoStatusFailureAction
  | GetAllGeofencesRequestAction
  | GetAllGeofencesSuccessAction
  | GetAllGeofencesFailureAction
  | SetSiteKeyStatusRequestAction
  | SetSiteKeyStatusSucessAction
  | SetSiteKeyStatusFailureAction
