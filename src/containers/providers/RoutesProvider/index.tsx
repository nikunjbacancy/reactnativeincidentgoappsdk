...
import {
  ...
  ContactScreen,
  EscortCountdownScreen,
  EscortRecordScreen,
  EscortRequestScreen,
  EscortSelectOrganizationScreen,
  EscortTimedEscortScreen,
  EscortTypeScreen,
  FeedbackScreen,
  MyAccountScreen,
  MyTipsScreen,
  NewTipSelectOrganizationScreen,
  NotificationScreen,
  OnboardingSelectOrganizationScreen,
  PermissionScreen,
...
const MyTipsTab = createMaterialTopTabNavigator(
  {
    [Screens.Menu.Tips.MyTips.Active]: {
      screen: MyTipsScreen,
      params: { tipStatus: TipStatus.Active },
      navigationOptions: {
        tabBarLabel: 'ACTIVE',
      },
    },
    [Screens.Menu.Tips.MyTips.Closed]: {
      screen: MyTipsScreen,
      params: { tipStatus: TipStatus.Closed },
      navigationOptions: {
        tabBarLabel: 'CLOSED',
      },
    },
