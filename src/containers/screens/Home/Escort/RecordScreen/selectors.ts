...
const recordScreenStateDomain = (state: RootState) =>
  state.escortRecordScreen || initialState;
...
const makeSelectRecordType = () =>
  createSelector(recordScreenStateDomain, ({ recordType }) => recordType);

const makeSelectMessages = () =>
  createSelector(recordScreenStateDomain, ({ messages }) => messages);
...
const makeSelectIsPanicMode = () =>
  createSelector(recordScreenStateDomain, ({ isPanicMode }) => isPanicMode);

const makeSelectFromPassiveEscort = () =>
  createSelector(
    recordScreenStateDomain,
    ({ fromPassiveEscort }) => fromPassiveEscort,
  );

const makeSelectAppState = () =>
  createSelector(recordScreenStateDomain, ({ appState }) => appState);

/**
 * Default selector used by RecordScreen
 */

const makeSelectRecordScreenState = () =>
  createSelector(recordScreenStateDomain, subState => subState);
