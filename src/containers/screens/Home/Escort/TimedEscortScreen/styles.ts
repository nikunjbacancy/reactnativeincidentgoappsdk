...
export const ProcedureList : any = styled(
  FlatList as new () => FlatList<ProcedureSelection>,
).attrs({
  contentContainerStyle: {
    flexGrow: 1,
    flexDirection: 'column',
...
export const ItemRowLis : any = styled.View`
  height: 60px;
  justify-content: center;
`;
...
export const NextButtonRow : any = styled.View`
